...
```sh
curl -Lo vind.tar.gz https://github.com/brightzheng100/vind/releases/download/v0.1.0/vind_0.1.0_darwin_arm64.tar.gz
...
```sh
curl -Lo vind.tar.gz https://github.com/brightzheng100/vind/releases/download/v0.1.0/vind_0.1.0_darwin_amd64.tar.gz
tar -xvf vind.tar.gz && chmod +x vind
sudo mv vind /usr/local/bin/
```
...
```sh
curl -Lo vind.tar.gz https://github.com/brightzheng100/vind/releases/download/v0.1.0/vind_0.1.0_linux_amd64.tar.gz
tar -xvf vind.tar.gz && chmod +x vind
sudo mv vind /usr/local/bin/
```
